  ...
  ngOnInit(): void {
    ...
    this.api.getOptionsReservation().subscribe((data: any[]) => {
      this.reservations = data.map((reservation: any) => ({
        ...
        rangeInit:this.addHoursAndFormat(datePipe,reservation.entry_reservation_date,5),
        rangeEnd: this.addHoursAndFormat(datePipe,reservation.departure_reservation_date,5),
